const ModelX = () => {
  return (
    <div className="bg-[url('/bg-2.avif')] py-32 bg-center bg-cover h-screen flex justify-between space-y-4 flex-col items-center">
      <div className="text-center">
        <div className="text-[44px] font-bold">Model X</div>
